---
title: "Transmission type effect on MPG"
...
This plot appears to show a definite relationship between the two, enough to justify moving forward with the study.
...
There are other methods that could have been used that would've come up with a different model, and there are some extra variables that could've been added in (e.g. a variable for the relationship between qsec and hp). However, for this study, I will not address those, and have chosen the model above.
